...
const getData = () => {
  ...
  sendHttpRequest('POST', `http://44.197.182.52:8080/teacher/courses`, data)
  .then(responseData => {
...
const getSectionList = (courseCode) => {
  return sendHttpRequest('POST', 'http://44.197.182.52:8080/course/section/list', {
...
const getDataAttendanceId = (courseCode, sectionNumber) => {
  return sendHttpRequest('POST', 'http://44.197.182.52:8080/attendance/add', {
    courseCode: courseCode,
