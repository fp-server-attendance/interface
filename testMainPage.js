...
const { window } = new JSDOM(``, { url: "http://3.226.237.9" });
...
const getData = () => {
  ...
  sendHttpRequest('POST', `http://3.226.237.9:8080/teacher/courses`, data)
  .then(responseData => {
...
const getDataForTesting = (username, password) => {
    ...
    return sendHttpRequest('POST', `http://3.226.237.9:8080/teacher/courses`, data)
      .then(responseData => {
